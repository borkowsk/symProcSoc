...
///////////////////////////////////////////////////////////////
// Funkcje obliczania statystyk dla �wiata  - wyodr�bnione
// �eby by�o �atwo znale�� i rozbudowywa�
////////////////////////////////////////////////////////////////////////////////
#include <fstream>
#include <map>
#include <list>
...
unsigned STAT_HISTOGRAM_WAZNOSCI=5;//Liczba przedzia��w histogram�w "wa�no�ci"
...
//�eby w razie NIEZB�DNEJ potrzeby mo�na by�o cos do niego dopisa�
ofstream StatLog;
bool StatLogPoprawny=false; //Informacja �e ju� mo�na u�ywa� StatLog
...
// kt�ry trzeba utworzy� jak go nie ma.																X DONE
// Najlepiej jakby plik nazywa� si� tak jak �r�d�o danych tyle �e
// z unikalnym dopiskiem utworzonym z daty i czasu. Rozszerzenie: .sdat
//-----------------------------------------------------------------------------
//Plik TAB DELIMITED z nag��wkiem,
//* W pierwszej kolumnie numer kroku.																X DONE
//NAJWA�NIEJSZE:																					X DONE
//* Kolejne kolumny z liczb� obiekt�w ka�dego typu znalezionego na liscie							X DONE
//    ElementModelu::WirtualnyKonstruktor::ListaNazwTypow()											X DONE
//Uporz�dkowana kategoriami "*Node", "*Proc", "*Link", "*Info"										X DONE
//Pewnie trzeba b�dzie u�y� jakiej� "mapy" (z STL), co niestety mo�e by� kosztowne					X DONE
//ale statystyki liczy si� nie zawsze w ka�dym kroku, a zliczanie konstrukcji						X DONE
//i destrukcji musia�oby by� zawsze.																X DONE

//JAK SI� UDA ZROBI� EFEKTYWNIE W OPARCIU O AKTUALNY INTERFAC										X DONE
//* Nazwa w�z�a o najwi�kszej liczbie po��cze� (albo kilku oddzielonych �rednikami jak r�wne)		X DONE
//* i ta liczba																						X DONE
//* i nazwa w�z�a najwi�kszej liczbie proces�w (j.w.)												X DONE
//* i ta liczba																						X DONE
//* link o najwi�kszej liczbie komunikat�w (identyfikowany przez nazw� pocz�tku i konca)			X DONE
//* i ta liczba																						X DONE
//(te� potrzebne "mapy" albo du�e tablice "r�wnoleg�e" do ukrytych tablic Swiata					X DONE

//TO SI� DA DO�� �ATWO:
//* Nazwa w�z�a o najwi�kszej wadze																	X DONE
//* i ta waga																						X DONE
//* link o najwyszej wadze i ta waga																X DONE
//** A potem osobno dla w�z��w i dla link�w histogramy Waznosc()'i w zadanej liczbie przedzia�ow	X DONE
{
	...
	//Powoduje utworzenie w mapie odpowiednich element�w
