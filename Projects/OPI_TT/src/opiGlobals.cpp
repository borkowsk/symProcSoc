...
extern float GENERYCZNY_POZIOM_PRZECIEKOW; //=0.01;//Jak czêsto domyœlny komunikat leci dalej ni¿ do odbiorcy
...
unsigned DefMaxLiczbaKomunikatow=10*1024; //Ile mo¿e jednoczeœnie istnieñ komunikatów w systemie

bool czytaj_parametry(int argc,const char* argv[])
{
    for(int i=1;i<argc;i++)
    {
        if(argv[i][0]=='-') //Parametr symshell'a do pominiêcia
            continue;
